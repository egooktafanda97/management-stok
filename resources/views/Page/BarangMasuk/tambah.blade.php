    ...
    <div class="page-content">
        <div class="row">
            <div class="col-12 mb-2">
                <div class="border-top border-0 border-4 rounded bg-white shadow-sm pt-2 pb-2 flex justify-between items-center h-full">
                    <div class="flex">
                        ...
                        <div x-data="{
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" id="harga_beli" name="harga_beli" placeholder="Harga Beli" required type="number" x-model="formData.harga_beli">
                                </div>

                                <div class="col-md-12">
                                    <label class="form-label" for="satuan_beli_id">Satuan Beli</label>
                                    <select class="form-control" id="satuan_beli_id" name="satuan_beli_id" required x-model="formData.satuan_beli_id">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" id="jumlah_barang_masuk" name="jumlah_barang_masuk" placeholder="Jumlah Barang Masuk" required type="number" x-model="formData.jumlah_barang_masuk">
                                </div>
                                ...
                                <tbody>
                                    <template :key="item.id" x-for="(item, index) in barang_masuk?.data ?? []">
                                        <tr>
                                            ...
                                            <td x-text="`${item.jumlah_barang_masuk} / ${item?.satuan_beli?.name ?? ''}`">
                                            </td>
                                            <td x-text="`${(item.jumlah_sebelumnya + item.jumlah_barang_masuk)} ${item?.satuan_sebelumnya?.name ?? ''}`">
                                            </td>
                                            <td>
                                                {{-- edit --}}
                                                <button @click="editBarangMasuk(item)" class="btn btn-warning btn-sm destory-items" title="edit barang masuk" x-show="item.produkPalingBaru ?? false">
                                                    <i class='bx bx-edit '></i>
                                                </button>
                                                <button @click="destorys(item.id, `/barangmasuk/cencel/${item.id}`)" class="btn btn-danger btn-sm destory-items" title="cancel barang masuk" x-show="item.produkPalingBaru ?? false">
