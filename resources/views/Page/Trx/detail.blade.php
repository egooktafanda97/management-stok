                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <div>
                                <button class="btn btn-secondary btn-sm" x-data="{ invoice: `{{ $trx->invoice->invoice_id }}` }" x-on:click="(()=>{
                    ...
                    <div class="col-md-7">
                        ...
                        <table class="table table-striped table-bordered" id="example" style="width:100%">
                            ...
                            <tr>
                                ...
                                <td>{{ "Rp ".number_format($item->priece) }}</td>
                                <td>{{ $item->jumlah }}</td>
                                <td>{{ "Rp ".number_format($item->transaksi->total_diskon) }}</td>
                                <td>{{ "Rp ".number_format($item->transaksi->tax_deduction) }}</td>
