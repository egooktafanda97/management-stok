                    ...
                    <div class="col-md-8 col-sm-12">
                        <div class="card" style="border-radius:5px!Important;overflow:hidden!important;">
                            <div class="card-header">
                                <h6 style="font-size:14px;"><i class="fadeIn animated bx bx-shopping-bag"></i> Keranjang
                                </h6>
                            </div>
                            <div class="card-body">
                                <div>
                                    ...
                                    <template :key="prod.id" x-for="prod in produkOrder">
                                        <div class="card"
                                            style="border: none;border-radius: 0px !important;border-bottom: 1px dashed rgba(0, 0, 0, 0.2);box-shadow:none;"
                                            x-show="produkOrder.length > 0">
                                            <div class="card-body"
                                                style="padding: 5px !important;border-radius: 0px !important;">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <strong class="text-primary" style="font-size:14px;"
                                                            x-text="prod.name"></strong>
                                                        <div class="flex flex-col">
                                                            <div class="block">
                                                                <select
                                                                    class="border border-1 border-gray-300 py-1 px-1 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                                                    x-on:change="hndelChangeUnit(prod.id,$event.target.value)">
                                                                    <option value="">Satuan</option>
                                                                    <template x-for="unitPrice in prod.unitPriceList">
                                                                        <option
                                                                            :selected="prod.satuan_active.id == unitPrice.id"
                                                                            :value="unitPrice.id"
                                                                            x-text="`${unitPrice.unit_name}`">
                                                                    </template>
                                                                </select>
                                                            ...
                                                            <div class="flex items-center">
                                                                @<span class=""
                                                                    class="text-sm text-red-500 text-gray-500 mr-5"
                                                                    x-text="formatRupiah(prod.price)"></span>
                                                                <small class="text-sm text-gray-300 mr-5 ml-5"
                                                                    style="font-size:10px!important"
                                                                    x-text="`-${prod.discount}%`">0</small>
                                                                <del class="text-sm text-gray-300 mr-5"
                                                                    style="font-size:10px!important"
                                                                    x-text="formatRupiah(prod.price_actual)"></del>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-2">
                                                    ...
                                                    <div class="col-sm-4 ">
                                                        <div class="relative"
                                                            style="position: absolute;bottom: 14px;right: 0px;">
                                                            <button @click="removeFromProdOrder(prod.id)"
                                                                class="text-white hover:text-red-500 w-[30px] h-[30px] bg-red-300 hover:bg-red-600 shadow-lg border-red-200 border-1 absolute top-[-15px] right-[-15px]">
                                                        ...
                                                        <div class="flex h-full items-center justify-end">
                                                            <div class="flex h-full items-center justify-end">
                                                                <span
                                                                    class="text-xl font-bold text-red-500 text-gray-500 mr-5"
                                                                    x-text="formatRupiah(prod?.subTotal ?? 0)"></span>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="flex flex-col items-center" x-show="listPayType.length > 0">
                                            <select class="form-control form-control-sm "
                                                style="padding:10px;color:#fff; border-radius:0px; border:none; background:#34b77e;"
                                                x-model="payTypeActived" x-on:change="((e)=>hndelPayTypeChange(e))">
                                                <option value="">Pilih Metode Pembayaran</option>
                                                <template :key="item.id" x-for="item in listPayType">
                                                    <option :selected="item.id === payTypeActived" :value="item.id"
                                                        x-text="item.name === 'CASH' ? 'TUNAI' : (item.name === 'DEBS' ? 'Hutang' : item.name)">
                                                    </option>
                                                </template>
                                            </select>
                                            <i class="bx bx-chevron-down"
                                                style="position:absolute; right:5px; color:#fff; font-size:20px; margin-top:5px"></i>
                                        </div>
                                            ...
                                            <div class="flex justify-between mb-2 py-1">
                                                ...
                                                <div>
                                                    <span class="text-sm text-gray-900"
                                                        x-text="formatRupiah(ringkasanTotal)"></span>
                                                </div>
                                            </div>
                                            <div class="pt-2 pb-2">
                                                <div class="flex justify-between items-center mb-3">
                                                    <div class="flex items-center">
                                                        <input class="border border-1 border-gray-300  py-1 px-1 w-20"
                                                            placeholder="Discount" type="number"
                                                            x-on:keyup="((e)=>discountChangeKeyup(e))" />
                                                ...
                                                <div class="flex justify-between items-center mb-3 d-none">
                                                    <div class="flex items-center">
                                                        <input checked class="form-checkbox h-3 w-3 text-blue-600 mr-3"
                                                            type="checkbox"
                                                            x-on:change="((e)=>{
                                                ...
                                                <div class="flex justify-between mb-2 py-1">
                                                    ...
                                                    <div>
                                                        <span class="text-lg font-semibold text-gray-600"
                                                            x-text="formatRupiah(subTotalBuyer)"></span>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div
                                            ...
                                            <div x-show="payTypeActived == 3">
                                                <div class="flex justify-between mb-2 py-1">
                                                    ...
                                                    <div>
                                                        <input
                                                            class="border border-1 border-red-500  py-1 px-1 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                                            placeholder="P I N"
                                                            style="width:100px!important;  border-radius:5px;  border: 2px solid #95d7a8 !important;width:140px;;"
                                                            type="password" x-model="pinOncardPayment">
                                                    </div>
                                                </div>
                                            </div>
                                            <div x-show="payTypeActived == 1">
                                                <div class="flex justify-between mb-2 py-1">
                                                    ...
                                                    <div>
                                                        <input
                                                            class="border border-1 border-red-500 shadow  py-1 px-1 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                                            id="rupiah" placeholder="Masukan jumlah pembayaran"
                                                            type="text"
                                                            x-on:keyup="((e)=>{
                                                ...
                                                <div class="flex justify-between mb-2 py-1">
                                                    ...
                                                    <div>
                                                        <span class="text-lg font-semibold text-gray-600"
                                                            x-text="formatRupiah(kembalian) ?? `Rp.0`">Rp. 0</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            style="position:relative; background:#e6f9ff; border-radius:2px; display:block">
                                            <div class="flex justify-between pl-4">
                                                <div>
                                                    <button @click="resetData" class="text-black font-bold py-2 px-4"
                                                        style="border-radius:0px;">
                                                        Batal
                                                    </button>
                                                    <i class="bx bx-x text-black"
                                                        style="position:absolute; left:10px; color:#fff; margin-right:0px; font-size:20px; margin-top:2px"></i>
                                                </div>

                                                <div>
                                                    <button @click="trxSubmit"
                                                        class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-20 text-center"
                                                        id="btnSubmit"
                                                        style="border-bottom-left-radius:100px!important;border-top-left-radius:100px!important;padding-right:35px!important; border-radius:0px;">
                                                        CHECKOUT
                                                    </button>
                                                    <i class="bx bx-chevron-right"
                                                        style="position:absolute; right:0px; color:#fff; margin-right:10px; font-size:20px; margin-top:2px"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
