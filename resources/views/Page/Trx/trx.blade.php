                            ...
                            <div class="card-body">
                                <div>
                                    ...
                                    <template :key="prod.id" x-for="prod in produkOrder">
                                        <div class="card border-top border-bottom border-0 border-4 border-success mt-2"
                                            x-show="produkOrder.length > 0">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <strong class="text-primary text-lg">p1</strong>
                                                        <div class="flex flex-col">
                                                            <div class="flex items-center">
                                                                ...
                                                                <select
                                                                    class="border border-1 ml-2 border-gray-300 rounded-md py-1 px-1 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                                            ...
                                                            <div class="flex items-center">
                                                                ...
                                                                <del class="text-sm text-gray-500 mr-5"
                                                    ...
                                                    <div class="col-sm-4 ">
                                                        <div class="relative">
                                                            <button @click="removeFromProdOrder(prod.id)"
                                                                class="text-white hover:text-red-500 w-[30px] h-[30px] bg-red-300 hover:bg-red-600 rounded-full shadow-lg border-red-200 border-1 absolute top-[-15px] right-[-15px]">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <select class="user-search form-control"></select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex justify-between mb-2 py-1">
                                            <div>
                                                <h4 class="text-lg font-semibold text-gray-600">Ringkasan Belanja</h4>
                                            </div>
                                            <div>
                                        ...
                                        <div class="pt-2 pb-2">
                                            <div class="flex justify-between items-center mb-3">
                                                <div class="flex items-center">
                                                    <div class="font-semibold text-sm">Diskon</div>
                                                    <input
                                                        class="border border-1 border-gray-300 rounded-md py-1 px-1 ml-2 w-20"
                                                        type="number" x-on:keyup="((e)=>discountChangeKeyup(e))" />
                                                    <span class="ml-2 text-lg">%</span>
                                                </div>
                                                <h2 class="font-semibold text-lg" x-text="formatRupiah(diskonIdr)">0</h2>
                                            </div>

                                            <div class="flex justify-between items-center mb-3">
                                                <div class="flex items-center">
                                                    <input checked class="form-checkbox h-5 w-5 text-blue-600 mr-3"
                                                        type="checkbox"
                                                        x-on:change="((e)=>{
                                                            unCheckPph(e.target.checked)
                                                        })" />
                                                    <div class="font-semibold text-sm">pph (<span x-text="pph"></span>)%
                                                    </div>
                                                </div>
                                                <h2 class="font-semibold text-lg" x-text="formatRupiah(pphIdr)">0</h2>
                                            </div>
                                        ...
                                        <hr>
                                        <div class="flex flex-col items-center py-2" x-show="listPayType.length > 0">
                                            <select class="form-control form-control-sm rounded-md"
                                        ...
                                        <div x-show="payTypeActived == 1">
                                            <div class="flex justify-between mb-2 py-1">
                                                <div>
                                                    <h4 class="text-lg font-semibold text-gray-600">Bayar</h4>
                                                </div>
                                                <div>
                                                    <input
                                                        class="border border-1 border-red-500 shadow rounded-md py-1 px-1 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
