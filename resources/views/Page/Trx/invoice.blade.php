...
<body>
    ...
    <table class="bill-details">
        <tbody>
            ...
            <tr>
                <td>Pelanggan #: <span>{{ $trx->buyer->nama ?? '' }}</span></td>
            </tr>
            <tr>
    ...
    <table class="items">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="line price">{{ 'Rp. ' . number_format($trx->total_gross) }}</td>
            </tr>
            <tr>
                <td class="sum-up" colspan="3">Diskon Transaksi {{ $trx->diskon }} %</td>
                <td class="price">{{ 'Rp. ' . number_format($trx->total_diskon) }}</td>
            </tr>
            <tr>
                <td class="sum-up" colspan="3">Pph {{ $trx->pph }} %</td>
                <td class="price">{{ 'Rp. ' . number_format($trx->tax_deduction) }}</td>
            </tr>
            <tr>
                <th class="total text" colspan="3">Total</th>
                <th class="total price">{{ 'Rp. ' . number_format($trx->sub_total) }}</th>
            </tr>
