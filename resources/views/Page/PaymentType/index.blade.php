                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li aria-current="page" class="breadcrumb-item active">Payment Types</li>
                        </ol>
                    </nav>
                </div>
                {{-- <div class="ms-auto">
                            ...
                            <tbody>
                                @foreach ($paymentTypes as $paymentType)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($paymentType->icon)
                                                <img alt="Icon" src="{{ asset('image/icons/' . $paymentType->icon) }}"
                                                    width="50">
                                            @else
                                                No icon
                                            @endif
                                        ...
                                        {{-- <td>
                                            <a class="btn btn-sm btn-primary"
                                                href="{{ url('paymenttype/edit', $paymentType->id) }}"><i
